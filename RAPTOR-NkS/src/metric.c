...
void metric_uu(double X_u[4], double g_uu[4][4]) {
    ...
    g_uu[3][1] = g_uu[1][3];
    g_uu[3][3] = irho2 / (sin2th);
    //fprintf(stderr, "x33 %e\n", X_u[3]);
    //fprintf(stderr, "x33 %e,%e,%e,%e,%e,%e\n", g_uu[0][0],g_uu[0][1],g_uu[1][1],g_uu[1][3],g_uu[2][2],g_uu[3][3]);
#elif (metric == MKSN)
...
//fprintf(stderr, "x33 %e,%e\n", photon_u[3],photon_u[3+4]);
 ...
 //  if (isnan(photon_u[2]) || isnan(photon_u[6])) {
//   if (k_u[1]==0) {
 //   fprintf(stderr, "x33 %e, %e\n", photon_u[6],photon_u[2]);
//   }
